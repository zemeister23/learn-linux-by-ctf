...
declare -A questions=(
    ...
    ["What is the Linux operating system known for? 2 words"]="open source"
    ...
    ["Create a new file in Linux with name examplefile?"]="touch examplefile"
    ["Remove a examplefile in Linux?"]="rm examplefile"
